export const PRODUCTS = [
  {
    ...
    price: 1299, originalPrice: 1800, emoji: "🏺",
    ...
    specs: [{key:"Material",val:"Clay & Natural Lacquer"},{key:"Finish",val:"Hand-painted lacquer"},{key:"Origin",val:"Karimnagar, Telangana"},{key:"GI Tag",val:"Yes – Registered"},{key:"Care",val:"Wipe with dry cloth"}],
    features: ["100% handmade by GI-certified artisans","Natural lacquer pigments","Each piece unique","Suitable for gifting"],
    sg: [
  ...
  },
  {
    ...
    price: 2499, originalPrice: 3200, emoji: "🕰️",
    ...
    features: ["Silent sweep movement","Mango wood base","GI-tagged craft","Ready to hang – hook included"],
    sg: [
  ...
  },
  {
    ...
    price: 3999, originalPrice: 5500, emoji: "🪟",
  ...
  },
  {
    ...
    price: 2799, originalPrice: 3800, emoji: "🛏️",
    ...
    features: ["Includes 2 pillow covers","Colourfast reactive print","GI-tagged Cheriyal art border","Soft 180 TC cotton"],
    sg: [
  ...
  },
  {
    ...
    price: 1899, originalPrice: 2600, emoji: "🏺",
    ...
    specs: [{key:"Material",val:"Clay & Natural Lacquer"},{key:"Set Contains",val:"3 pots – different motifs"},{key:"Heights",val:"4\", 5\", 6\" approx."},{key:"GI Tag",val:"Yes"},{key:"Care",val:"Wipe dry, avoid moisture"}],
    features: ["3 unique motifs per set","Gifting-ready packaging","All-natural lacquer paint","Certified GI craft"],
    sg: [
  ...
  },
  {
    ...
    price: 3299, originalPrice: 4500, emoji: "🦚",
  ...
  },
  {
    ...
    price: 1599, originalPrice: 2200, emoji: "🪟",
  ...
  },
  {
    ...
    price: 1999, originalPrice: 2700, emoji: "🛏️",
  ...
  },
  {
    ...
    price: 899, originalPrice: 1400, emoji: "🎨",
  ...
  },
  {
    ...
    price: 4599, originalPrice: 6000, emoji: "🪔",
    ...
    specs: [{key:"Material",val:"Clay + Natural Lacquer"},{key:"Fitting",val:"E14 bulb fitting included"},{key:"Height",val:"Approx. 30 cm (single)"},{key:"GI Tag",val:"Yes"},{key:"Care",val:"Wipe dry, avoid water"}],
    features: ["Electric fitting included","E14 bulb socket","GI-certified craft","Gifting box available"],
    sg: [
  ...
  },
  {
    ...
    price: 799, originalPrice: 1200, emoji: "🛋️",
  ...
  },
  {
    ...
    price: 699, originalPrice: 1000, emoji: "🎍",
    ...
    features: ["Handwoven on traditional loom","Natural cotton fringe","Hemmed edges","GI craft region"],
    sg: [
