...
export default function SuccessPage({order, setPage}) {
  ...
  return (
    <div className="succ-wrap">
      ...
      <h2>Order Placed!</h2>
      <p>Thank you for supporting Cheriyal artisans. Your order has been confirmed and will be shipped soon. We've emailed your invoice to {order.userEmail || "you"}.</p>
      ...
      <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
        <button className="btn-sf" onClick={() => setShowInvoice(true)}>🧾 View / Download Invoice</button>
        <button className="btn-out" onClick={() => setPage("shop")}>Continue Shopping</button>
